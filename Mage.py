...
print("Welcome to Kingsforth! We are very interested to discover who you are...")
...
while True:
    ...
    if player_class == "Warrior":
        print("Ah.. so you are a Warrior...")

    elif player_class == "Mage":
        print("Interesting.. so you are a Mage...")
   
    elif player_class == "Theif":
        print("Oh my.. so you are a Theif...")
